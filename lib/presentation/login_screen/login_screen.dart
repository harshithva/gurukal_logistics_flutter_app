...
import 'package:gurukal/data/models/login/post_login_req.dart';
...
class LoginScreen extends GetWidget<LoginController> {
                            ...
                            children: [
                              ...
                              Align(
                                  ...
                                  child: Padding(
                                      ...
                                      child: Text("msg_login_track_all".tr,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.center,
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              hintStyle: AppStyle.textstylepoppinsregular16.copyWith(
                                              ...
                                              focusedBorder: OutlineInputBorder(
                                                  ...
                                                  borderSide: BorderSide(color: ColorConstant.gray400, width: 1)),
                                              isDense: true,
                                              contentPadding: EdgeInsets.only(left: getHorizontalSize(20.00), top: getVerticalSize(19.38), bottom: getVerticalSize(19.38))),
                                          style: TextStyle(color: ColorConstant.black900, fontSize: getFontSize(16.0), fontFamily: 'Poppins', fontWeight: FontWeight.w400)))),
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: getHorizontalSize(28.00),
                                  ...
                                  child: Container(
                                      ...
                                      child: TextFormField(
                                          controller:
                                              controller.inputActiveController,
                                          obscureText: true,
                                          decoration: InputDecoration(
  ...
  void onTapBtnLogin() {
    PostLoginReq postLoginReq = PostLoginReq(
      email: controller.inputController.text,
      password: controller.inputActiveController.text,
    );
  ...
  void _onCreateLoginSuccess() {
    Get.find<PrefUtils>().setUser(controller.postLoginResp.user!);
    Get.defaultDialog(
        onConfirm: () => Get.back(), title: "Hello", middleText: "Hello");
  }
